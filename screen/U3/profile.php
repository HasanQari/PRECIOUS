    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col text-start">
                <a href="setting.php"><i class="social-icon bi bi-gear"></i></a>
            </div>
        </div>
        ...
        <div class="container-fluid mb-3 py-3 text-center">
            <div id="PORTFOLIO" class="row">
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
                        <a href="view/account.php"><i class="bi bi-person-circle btn-icon whitey"></i></a>
                        <h6 class="whitey">ملفي الشخصي</h6>
                    </div>
                </div>
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
            ...
            <div id="PORTFOLIO" class="row">
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
                        <a href="view/course.php"><i class="bi bi-book btn-icon whitey"></i></a>
                        <h6 class="whitey">الدورات والمهارات</h6>
                    </div>
                </div>
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
                        <a href="view/store.php"><i class="bi bi-basket2 btn-icon whitey"></i></a>
            ...
            <div id="PORTFOLIO" class="row">
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
                    <a href="view/like.php"><i class="bi bi-star btn-icon whitey"></i></a>
                        <h6 class="whitey">المفضلة</h6>
                    </div>
                </div>
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
                    <a href="view/order.php"><i class="bi bi-card-list btn-icon whitey"></i></a>
                        <h6 class="whitey">سجل الطلبات</h6>
                    </div>
                </div>
            </div><br>
            <div id="PORTFOLIO" class="row">
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
                        <i class="bi bi-receipt-cutoff btn-icon"></i>
                        <h6 class="whitey">بحث عن موهوب</h6>
                    </div>
                </div>
                <div class="col">
                    <div id="btn-container" class="text-center bg-g2 py-1 px-1 whitey">
                        <i class="bi bi-building btn-icon"></i>
                        <h6 class="whitey">بيانات الشركة</h6>
                    </div>
                </div>
            </div><br>
        </div>
